...
export default function ResumeContent() {
  ...
  const skillCategories = [
    {
      name: "Frontend",
      items: ["React", "Next.js", "TypeScript", "TailwindCSS", "JS"],
    },
    {
      name: "Backend",
      items: ["Laravel", "PHP", "REST API", "Express", "Python"],
    },
                ...
                <div className="space-y-4 print:space-y-1.5">
                  {educationData.map((edu, i) => (
                    <div key={i} className="print:leading-tight">
                      <p className="font-bold text-xs print:text-[8pt] mb-0">
                        {edu.degree[lang]}
                      </p>
                      <p className="text-[9px] text-zinc-500 print:text-zinc-600 print:text-[7pt] mb-0">
                        {edu.institution}
                      </p>
              ...
              <section>
                ...
                <div className="space-y-10 print:space-y-2">
                  {experienceMeta.map((exp, i) => (
                    <div
                      key={i}
                      className="relative pl-6 border-l border-outline-variant/10 print:pl-4 print:border-zinc-100"
                    >
                      ...
                      <div className="flex justify-between items-start mb-1 print:mb-0">
                        <h3 className="font-bold text-lg print:text-[9.5pt] leading-tight text-on-surface dark:text-white print:text-black">
                          {exp.title}
                        </h3>
                        <span className="text-[10px] text-zinc-500 font-bold print:text-black print:text-[7.5pt] shrink-0">
                          {exp.period}
                        </span>
                      </div>
                      <p className="text-primary text-[13px] font-bold mb-2 print:text-primary print:text-[8.5pt] print:mb-0.5">
                        {exp.company}
                      </p>
