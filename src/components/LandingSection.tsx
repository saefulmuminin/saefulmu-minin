...
const TECH_PILLS = [
  {
    name: "Next.js",
    color: "#d4d4d4",
    bg: "rgba(212,212,212,0.10)",
    border: "rgba(212,212,212,0.45)",
  },
  {
    name: "React",
    color: "#61DAFB",
  ...
  },
  {
    ...
    border: "rgba(49,120,198,0.55)",
  },
  {
    name: "Laravel",
    color: "#FF2D20",
    bg: "rgba(255,45,32,0.12)",
    border: "rgba(255,45,32,0.55)",
  },
  {
    name: "Tailwind",
    color: "#06B6D4",
...
function Card3DModal({
  ...
  const [rot, setRot] = useState({ x: 10, y: -0.25 });
  ...
  return (
    ...
    >
      ...
      {/* Hint - moved to top */}
      <p className="absolute top-20 left-1/2 -translate-x-1/2 text-[10px] font-label tracking-[0.4em] text-white/40 uppercase pointer-events-none">
        {t.landing3d.hint}
      </p>
        ...
        >
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-[10px] font-label font-bold tracking-[0.4em] text-outline uppercase">
                {t.landing3d.backLabel}
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-1.5 mt-1">
              {project?.tags.slice(0, 4).map((tag) => (
                <span
                  key={tag}
                  className="text-[9px] font-label px-2.5 py-1 rounded-full bg-surface-container text-on-surface-variant border border-outline-variant"
                >
                  {tag}
                </span>
              ))}
      ...
      {/* Detail Block at the bottom */}
      <div className="absolute bottom-10 left-0 right-0 flex flex-col items-center gap-6 px-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
        <div className="text-center max-w-xl">
          <p className="text-[10px] font-label font-bold tracking-[0.5em] text-primary uppercase mb-2">
            {project?.category}
          </p>
          <h4 className="text-3xl sm:text-4xl md:text-5xl font-headline font-bold text-white tracking-tight drop-shadow-2xl">
            {project?.title}
          </h4>
        </div>
        ...
        <Link
          href={`/work/${slug}`}
          className="group relative flex items-center gap-3 px-10 py-4 rounded-full overflow-hidden transition-all duration-500 hover:scale-110 active:scale-95"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Glass background */}
          <div className="absolute inset-0 bg-white/10 backdrop-blur-md border border-white/20 group-hover:bg-white/20 transition-colors" />
          ...
          <span className="relative text-white text-xs font-label font-bold uppercase tracking-[0.2em]">
            {t.landing3d.viewProjectDetail}
          </span>
          <span className="relative material-symbols-outlined text-[20px] text-white group-hover:translate-x-1.5 transition-transform duration-300">
            arrow_forward
          </span>
        </Link>
      </div>
    ...
    >
      ...
      <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/20">
          ...
          <span className="text-[9px] font-label font-bold text-white tracking-[0.2em] uppercase">
            {t.landing3d.view3d}
          </span>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          ...
          style={{
            right: "10%",
            top: "12%",
            transform: `translate(${(mouse.x - 50) * 2 * PF}px,${(mouse.y - 50) * 2 * PF}px)`,
        ...
        <div
          ...
          style={{
            left: "8%",
            top: "35%",
            transform: `translate(${(mouse.x - 50) * 1 * PF}px,${(mouse.y - 50) * 1 * PF}px)`,
            transition: "transform 0.3s ease-out",
          }}
        >
          <svg
        ...
        <div
          ...
          style={{
            left: "5%",
            bottom: "18%",
            transform: `translate(${(mouse.x - 50) * 3 * PF}px,${(mouse.y - 50) * 3 * PF}px)`,
        ...
        >
          <svg
            ...
            fill="none"
            style={{
              animation: "spinSlowReverse 32s linear infinite",
              opacity: isDark ? 0.1 : 0.07,
            }}
          >
            <polygon
              points="50,5 97,36 79,91 21,91 3,36"
              stroke={palette[5]}
              strokeWidth="2"
            />
            <polygon
              points="50,20 80,42 69,77 31,77 20,42"
              stroke={palette[1]}
              strokeWidth="1"
              strokeDasharray="3 3"
            />
      ...
      >
        ...
        <div
          style={{
            transform: `translate(${(hlMouse.x - 50) * 0.07}px,${(hlMouse.y - 50) * 0.04}px)`,
            transition: "transform 0.25s ease-out",
          }}
        >
          <div
        ...
        <h2 className="font-headline font-bold leading-[1.08] tracking-tighter">
          ...
          <div
            style={{
              transform: `translate(${(hlMouse.x - 50) * 0.1}px,${(hlMouse.y - 50) * 0.06}px)`,
          ...
          <div
            style={{
              transform: `translate(${(hlMouse.x - 50) * 0.22}px,${(hlMouse.y - 50) * 0.13}px)`,
          ...
          <div
            style={{
              transform: `translate(${(hlMouse.x - 50) * 0.15}px,${(hlMouse.y - 50) * 0.09}px)`,
        ...
        <div
          style={{
            transform: `translate(${(hlMouse.x - 50) * 0.06}px,${(hlMouse.y - 50) * 0.04}px)`,
        ...
        <div
          style={{
            transform: `translate(${(hlMouse.x - 50) * 0.04}px,${(hlMouse.y - 50) * 0.03}px)`,
      ...
      <div className="relative mt-8 sm:mt-10 flex flex-col gap-6 sm:gap-8">
        ...
        <div className="flex gap-2 sm:gap-3 items-end">
          {(
            ...
            <div
              key={i}
              className={img.mobileHide ? "hidden sm:contents" : "contents"}
            >
              <ProjectCard
                slug={img.slug}
                rotate={img.rotate}
        ...
        <div className="flex flex-wrap gap-8 sm:gap-14">
          <div>
            <p className="font-headline text-5xl sm:text-7xl font-bold text-primary leading-none">
              4+
            </p>
